...
public sealed class PairHandler : DisposableMediatorSubscriberBase
{
    ...
    public unsafe uint PlayerCharacterId => (_charaHandler?.Address ?? nint.Zero) == nint.Zero
        ? uint.MaxValue
        : ((GameObject*)_charaHandler!.Address)->EntityId;
    ...
    public void ApplyCharacterData(Guid applicationBase, CharacterData characterData, bool forceApplyCustomization = false)
    {
        ...
        {
            Mediator.Publish(new EventMessage(new Event(PlayerName, Pair.UserData, GetType().Name, EventSeverity.Warning,
    ...
    protected override void Dispose(bool disposing)
    {
        ...
        try
        {
            ...
            {
                Mediator.Publish(new EventMessage(new Event(name, Pair.UserData, GetType().Name, EventSeverity.Informational, "Disposing User")));
            }
